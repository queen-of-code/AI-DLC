...
4. Read `.claude/skills/plan/SKILL.md` — you are the agent described in its **Orchestration** section.
   ...
   - Skip "Conversation first" — document assumptions under an **Assumptions** section in the spec instead.
   - Do not ask open questions in chat; make reasonable assumptions and note them.
