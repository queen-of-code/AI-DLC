...
2. For **github-projects-v2** (recommended headless Cursor queue), point to **[GITHUB-AIDLC-QUEUE.md](https://github.com/queen-of-code/AI-DLC/blob/main/docs/GITHUB-AIDLC-QUEUE.md)** — copy queue workflow templates, configure Projects v2 field **`AIDLC phase`**, secrets/vars, Cursor `AIDLC_GH_CALLBACK_TOKEN`.
3. For **github-projects-classic** (or label-only automation on classic boards), point to **[GITHUB-AIDLC-PROJECT.md](https://github.com/queen-of-code/AI-DLC/blob/main/docs/GITHUB-AIDLC-PROJECT.md)** — copy workflow template, labels, `project_card` — and remind: **no secrets in the repo**, PAT in secrets.
